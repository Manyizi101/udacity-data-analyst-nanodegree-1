...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 15 18:52:05 2017
...
API_KEY = { "popular": "423aaa1ecc5c490ba4886650c1b0ccba",
            "article": "423aaa1ecc5c490ba4886650c1b0ccba"}
...
def article_overview(kind, period):
    ...
    for news in data:
        news_dict = {}
        news_dict[news['section']] = news['title']
        titles.append(news_dict)
        if news.has_key('media') == True:
